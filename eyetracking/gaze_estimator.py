...
class GazeEstimator:
    ...
    def estimate_gaze(self, image: np.ndarray, face: Face) -> None:
        ...
        face_rot = face.change_coordinate_system(euler_angles) # pitch, yaw, roll
        if len(self.facerot) > 10:
            self.facerot.pop(0)
        self.facerot.append(face_rot)
        # print("center",self.facerot)
